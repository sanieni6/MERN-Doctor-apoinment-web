            ...
            <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
              <div>
                <div className="lg:w-[570px]">
                  <h1
                    className="text-[36px] leading-[46px] text-headingColor font-[800px] 
              md:text-[60px] md:leading-[70px]"
                  ...
                  <p className="text__para">
                    ...
                    Veritatis ex enim expedita a natus praesentium pariatur
                    libero cum dolor nesciunt. Ipsa quos cum vitae quae minus,
                    ipsam eligendi maiores necessitatibus.
                  </p>
